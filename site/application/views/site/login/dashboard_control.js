...
const displayServer = (serverid) => {
    ...
    container.innerHTML = " <div class=\"row\"> <div class=\"col-sm\" id=\"serverNumber\"> Selected server is #" + serverid + "</div> </div> <div class=\"row mt-3\"> <div class=\"col-sm\"> <div class=\"card h-100\"> <h5 class=\"card-header\">Change Teamnames</h5> <div class=\"card-body\"> <form> <div class=\"form-group\"> <input type=\"text\" class=\"form-control\" id=\"changeteam_team01\" placeholder=\"Name for Team 01\" required=\"true\"> </div> <div class=\"form-group\"> <input type=\"text\" class=\"form-control\" id=\"changeteam_team02\" placeholder=\"Name for Team 02\" required=\"true\"> </div> <button type=\"button\" class=\"btn btn-success\" onclick=\"changeTeamname(" + serverid + ")\">Submit</button> </form> </div> </div> </div> <div class=\"col-sm\"> <div class=\"card h-100\"> <h5 class=\"card-header\">Change Flags</h5> <div class=\"card-body\"> <form> <div class=\"form-group\"><label for=\"changeflag_team01\">Flag for team 01</label><select class=\"selectpicker\" id=\"changeflag_team01\" data-live-search=\"true\"></select></div> <div class=\"form-group\"> <label for=\"changeflag_team02\">Flag for team 02</label><select class=\"selectpicker\" id=\"changeflag_team02\" data-live-search=\"true\"></select></div> <button type=\"button\" class=\"btn btn-success\" onclick=\"changeFlag(" + serverid + ")\">Submit</button> </form> </div> </div> </div> </div><div class=\"row mt-3\"> <div class=\"col-sm\"> <div class=\"card h-100\"> <h5 class=\"card-header\">Change Map</h5> <div class=\"card-body\"> <form> <div class=\"form-group\"> <label for=\"changemap\">Maps</label><select class=\"selectpicker\" id=\"changemap\" data-live-search=\"true\"></select></div> <button type=\"button\" class=\"btn btn-success\" onclick=\"changeMap(" + serverid + ")\">Submit</button> </form> </div> </div> </div> <div class=\"col-sm\"> <div class=\"card h-100\"> <h5 class=\"card-header\">Change Status</h5> <div class=\"card-body\"> <form> <div class=\"form-group\"> <input type=\"text\" class=\"form-control\" id=\"changestatus_txt\" placeholder=\"Text\"> </div> <div class=\"form-group\"> <input type=\"text\" class=\"form-control\" id=\"changestatus_team01\" placeholder=\"Status for Team 01\" required=\"true\"> </div> <div class=\"form-group\"> <input type=\"text\" class=\"form-control\" id=\"changestatus_team02\" placeholder=\"Status for Team 02\" required=\"true\"> </div> <button type=\"button\" class=\"btn btn-success\" onclick=\"changeStatus(" + serverid + ")\">Submit</button> </form> </div> </div> </div> </div> </div>"
